...
import { LayoutDashboard, History, LogOut, QrCode, Settings, FileText, Clock, Wallet, Wifi, Activity } from "lucide-react";
...
export function DashboardNav() {
  ...
  const menuItems = [
    ...
    { href: "/dashboard/analytics", label: "Analytics", icon: Activity, roles: ['Owner', 'Admin'] },
    ...
    { href: "/dashboard/bri-test", label: "Tes BRI", icon: Activity, roles: ['Owner'] },
  ];
